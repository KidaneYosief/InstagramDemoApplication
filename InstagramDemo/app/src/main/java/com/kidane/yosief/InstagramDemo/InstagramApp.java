...
import com.kidane.yosief.InstagramDemo.Helper.Utils;
...
/**
 * Created by kidane yosief on 11/21/2015.
 */
...
//urlConnection.connect();
                    ...
                    String pict= jsonObj.getJSONObject("user").getString("profile_picture");
                    ...
                    mSession.storeAccessToken(mAccessToken, id, user, name,pict);
                } catch (Exception ex) {
                    what = WHAT_ERROR;
                    ex.printStackTrace();
                }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.i("pict", data_obj.getString(TAG_PROFILE_PICTURE) + " 1");
    ...
    public String getPictureProf() {
        return mSession.getApiPict();
    }
